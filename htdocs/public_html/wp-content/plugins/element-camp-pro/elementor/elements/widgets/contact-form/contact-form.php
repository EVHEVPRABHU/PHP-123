...
class TCG_Contact_Form extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_responsive_control(
            'input_width',
            [
                'label' => esc_html__( 'Input Width', 'themescamp-core' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form {{CURRENT_ITEM}}' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'left',
                'options' => [
                    'left' => esc_html__('Before', 'themescamp-core'),
                    'right' => esc_html__('After', 'themescamp-core'),
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_responsive_control(
            'space_between_x',
            [
                'label' => esc_html__('Space Between (Horizontal)', 'themescamp-core'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'unit' => 'px',
                ],
                ...
                'condition' => [
                    'form_wrapper_display' => 'flex'
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form' => 'margin-right: -{{SIZE}}{{UNIT}}; margin-left: -{{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form > *' => 'padding-right: {{SIZE}}{{UNIT}}; padding-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form' => 'justify-content: {{VALUE}};',
                ],
                'condition'=>['form_wrapper_display'=>['flex','inline-flex']],
                'responsive' => true,
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form' => 'align-items: {{VALUE}};',
                ],
                'condition'=>['form_wrapper_display'=>['flex','inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcg-contact-form .tcg-contact-form-wrapper .tcg-contact-form-form' => 'flex-wrap: {{VALUE}};',
                ],
                'condition'=>['form_wrapper_display'=>['flex','inline-flex']],
            ]
        );
        ...
        $this->add_control(
            'field_text_color_dark_mode',
            [
                'label' => esc_html__( 'Text Color', 'themescamp-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-field-group .tcg-input' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-field-group .tcg-input' => 'color: {{VALUE}};',
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-field-group textarea' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-field-group textarea' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'field_tcg_input_background_dark_mode',
                'selector' => '{{WRAPPER}} .tcg-field-group .tcg-input',
                'types' => ['classic', 'gradient'],
                'fields_options' => [
                    'background' => [
                        'label' => esc_html_x('Input Background Color', 'Background Control', 'themescamp-plugin'),
                    ],
                    'color' => [
                        'selectors' => [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'field_textarea_background_dark_mode',
                'selector' => '{{WRAPPER}} .tcg-field-group textarea',
                'types' => ['classic', 'gradient'],
                'fields_options' => [
                    'background' => [
                        'label' => esc_html_x('TextArea Background Color', 'Background Control', 'themescamp-plugin'),
                    ],
                    'color' => [
                        'selectors' => [
                            '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{SELECTOR}}' => 'background-color: {{VALUE}};',
        ...
        $this->add_control(
            'field_border_dark_mode',
            [
                'label' => esc_html__( 'Border Color', 'themescamp-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-field-group .tcg-input' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-field-group .tcg-input' => 'border-color: {{VALUE}};',
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-field-group textarea' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-field-group textarea' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic','gradient' ],
                'selector' => '{{WRAPPER}} .tcg-field-group .tcg-input:focus,{{WRAPPER}} .tcg-field-group textarea:focus',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .tcg-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submit_button_transform_options',
            [
                'label' => esc_html__('Button Transform', 'themescamp-core'),
        ...
        $this->start_popover();
        $this->add_control(
            'submit_button_translate_y',
            [
                'label' => esc_html__( 'Translate Y', 'themescamp-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-button' => '--e-transform-tcg-contact-form-tcg-submit-button-translateY: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            'submit_button_translate_x',
            [
                'label' => esc_html__( 'Translate X', 'themescamp-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-button' => '--e-transform-tcg-contact-form-tcg-submit-button-translateX: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->add_control(
            'submit_button_transform_options_hover',
            [
                'label' => esc_html__('Button Transform', 'themescamp-core'),
                'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off' => esc_html__('Default', 'themescamp-core'),
        ...
        $this->start_popover();
        $this->add_control(
            'submit_button_translate_y_hover',
            [
                'label' => esc_html__( 'Translate Y', 'themescamp-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-button:hover' => '--e-transform-tcg-contact-form-tcg-submit-button-translateY: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            'submit_button_translate_x_hover',
            [
                'label' => esc_html__( 'Translate X', 'themescamp-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-button:hover' => '--e-transform-tcg-contact-form-tcg-submit-button-translateX: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'section_submit_button_icon_style',
            [
                'label' => esc_html__('Submit Button Icon', 'themescamp-core'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'button_selected_icon!' => '',
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-button .button-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcg-button .button-icon svg' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'icon_color',
            [
                'label'     => esc_html__('Icon Color', 'themescamp-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcg-button .button-icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcg-button .button-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'submit_button_icon_margin',
            [
                'label' => esc_html__('Margin', 'themescamp-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em' , 'rem' , 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-button .button-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    public function form_fields_render_attributes()
    {
        ...
        if (! empty($settings['button_size'])) {
            $this->add_render_attribute('submit-group', 'class', 'tcg-button-wrapper-full-width');
    ...
    public function contact_form_html()
    {
        ...
        <div class="tcg-contact-form-wrapper">
            <form <?php $this->print_render_attribute_string('contact-form'); ?>>
                ...
                <div class="<?php echo implode(' ', ['tcg-field-group', 'elementor-field-required', 'tcg-width-1-1', $repeater_class]); ?>">
                    <?php } else { ?>
                    <div class="<?php echo implode(' ', ['tcg-field-group', $repeater_class]); ?>">
                        <?php };
                        ...
                        switch ($item['field_type']) {
                            ...
                            case 'name':
                                ...
                                if($item['name_field_type'] == 'double') {
                                    echo '<input type="text" name="name2" id="'. $field_id .'" placeholder="'. $item['field2_placeholder'] .'" class="tcg-input" '. $is_field_required .'>';
                                }
                                break;
                            case 'email':
                    ...
                    <div <?php $this->print_render_attribute_string('submit-group'); ?>>
                        <button type="submit" <?php $this->print_render_attribute_string('button'); ?>>
                            <?php
                            // Render left icon
                            if (!empty($settings['button_selected_icon']['value']) && $settings['button_icon_align'] === 'left') {
                                $this->render_button_icon($settings['button_selected_icon'], 'left');
                            }
                            ...
                            // Render right icon
                            if (!empty($settings['button_selected_icon']['value']) && $settings['button_icon_align'] === 'right') {
                                $this->render_button_icon($settings['button_selected_icon'], 'right');
                            }
                            ?>
                        </button>
    ...
    private function render_button_icon($icon, $alignment)
    {
        if (!empty($icon['value'])) {
            $migrated = isset($icon['__fa4_migrated']);
            $is_new = empty($icon['icon']) && \Elementor\Icons_Manager::is_migration_allowed();

            echo '<span class="button-icon button-icon-' . esc_attr($alignment) . '">';
            if ($is_new || $migrated) {
                \Elementor\Icons_Manager::render_icon($icon, ['aria-hidden' => 'true']);
            } else {
                echo '<i class="' . esc_attr($icon['icon']) . '" aria-hidden="true"></i>';
            }
            echo '</span>';
        }
    }
