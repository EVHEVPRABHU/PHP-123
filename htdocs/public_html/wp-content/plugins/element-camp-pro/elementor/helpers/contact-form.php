...
if ( ! function_exists( 'themescamp_is_valid_captcha' ) ) {

function themescamp_is_valid_captcha()
{
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!$error && $form_data['recaptcha'] != 'false') {
            if (!empty($tcg_contact_form_recaptcha_site_key) and !empty($tcg_contact_form_recaptcha_secret_key)) {
                if (!themescamp_is_valid_captcha()) {
                    $error  = true;
...
if ( ! function_exists( 'message_html' ) ) {
