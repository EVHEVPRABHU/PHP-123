...
add_action( 'widgets_init', 'themescamp_plg_n');

if( !function_exists('themescamp_plg_n') ){
function themescamp_plg_n() {

   /**
    * Registering widget areas for front page
    */
   register_widget( "themescamp_newsletter_widget" );
}}

if ( ! class_exists( 'themescamp_newsletter_widget' ) ) {
class themescamp_newsletter_widget extends WP_Widget {

    public function __construct() {
        $widget_ops = array('classname' => 'themescamp_newsletter_widget', 'description' => __('themescamp newsletter'));
        $control_ops = array('width' => 100, 'height' => 100);
        parent::__construct('texti', __('Themescamp Newsletter'), $widget_ops, $control_ops);
    }
