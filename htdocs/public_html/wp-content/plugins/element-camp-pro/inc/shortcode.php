<?php
namespace Elementor;
if ( ! function_exists( 'Elementor\themescamp_insert_elementor' ) ) {
...
if ( ! function_exists( 'Elementor\themescamp_enable_elementor' ) ) {
...
if ( ! function_exists( 'Elementor\print_themescamp_data' ) ) {
