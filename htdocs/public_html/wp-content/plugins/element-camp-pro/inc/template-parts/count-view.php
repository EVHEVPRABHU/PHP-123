...
if ( ! function_exists( 'themescamp_get_post_view' ) ) {
...
if ( ! function_exists( 'themescamp_set_post_view' ) ) {
...
if ( ! function_exists( 'themescamp_posts_column_views' ) ) {
...
if ( ! function_exists( 'themescamp_posts_custom_column_views' ) ) {
...
if ( ! function_exists( 'themescamp_time_ago' ) ) {
