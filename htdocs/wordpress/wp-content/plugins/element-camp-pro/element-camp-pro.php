<?php
/**
 * Plugin Name: ElementCamp Pro
 * Plugin URI: https://themescamp.com/potfolio
 * Description: ThemesCamp core plugin for WordPress Premium Themes.
 * Author: themesCamp
 ...
 */
function elementcamp_pro_upgrade_check() {
    if ( is_plugin_active( 'themescamp-core/plugin.php' ) ) {
        // Deactivate old plugin
        deactivate_plugins( 'themescamp-core/plugin.php' );
        delete_plugins( array( 'themescamp-core/plugin.php' ) );
    }
}
register_activation_hook( __FILE__, 'elementcamp_pro_upgrade_check' );

if ( ! defined( 'VERSION' ) ) { define( 'VERSION', '2.1.7' ); }
if ( ! defined( 'THEMESCAMP__FILE__' ) ) { define( 'THEMESCAMP__FILE__', __FILE__ );}
if ( ! defined( 'THEMESCAMP_URL' ) ) { define( 'THEMESCAMP_URL', plugins_url( '/', THEMESCAMP__FILE__ ) );}
if ( ! defined( 'THEMESCAMP_PLUGIN_BASE' ) ) { define( 'THEMESCAMP_PLUGIN_BASE', plugin_basename( THEMESCAMP__FILE__ ) );}
if ( ! defined( 'TCG_BADGE' ) ) { define( 'TCG_BADGE', '<span class="tc-e-badge"></span>');}


/*============================================== Plugin Load ============================================*/

// Load the plugin after other plugins are loaded.
if ( ! function_exists( 'themescamp_plgn_load' ) ) {
...
if ( ! function_exists( 'themescamp_plugin_fail_load_out_of_date' ) ) {
...
if ( ! function_exists( 'themescamp_theme_setup' ) ) {
...
if ( ! function_exists( 'themescamp_exclude_tcg_teb_block_from_elementor_admin_bar' ) ) {
...
if ( ! function_exists( 'themescamp_remove_iframe_attributes' ) ) {
...
if ( ! function_exists( 'themescamp_remove_noscript_attributes' ) ) {
...
if ( ! function_exists( 'themescamp_start_wp_head_buffer' ) ) {
    function themescamp_start_wp_head_buffer(){
        ob_start();
    }
}

if ( ! function_exists( 'themescamp_end_wp_head_buffer' ) ) {
...
if ( ! function_exists( 'themescamp_remove_wordpress_generator' ) ) {
...
if ( ! function_exists( 'themescamp_custom_styles_to_head' ) ) {
...
//plugin translation 
if ( ! function_exists( 'themescamp_textdomain_translation' ) ) {
...
//CPT templates
if ( ! function_exists( 'themescamp_template_redirect' ) ) {
...
if ( ! function_exists( 'themescamp_templates' ) ) {
...
if ( ! function_exists( 'themescamp_nav_description' ) ) {
...
if ( ! function_exists( 'themescamp_custom_menu_page' ) ) {
...
//function custom header by page settings
if ( ! function_exists( 'themescamp_custom_flat_menu_page' ) ) {
...
//related post
if ( ! function_exists( 'themescamp_related_post' ) ) {
...
if ( ! function_exists( 'themescamp_search_form' ) ) {
...
//Get unique ID. 
if ( ! function_exists( 'themescamp_unique_id' ) ) {
...
if ( ! function_exists( 'themescamp_admin_bar_menu' ) ) {
