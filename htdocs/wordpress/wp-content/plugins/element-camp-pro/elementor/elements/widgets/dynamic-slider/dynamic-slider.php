...
use ThemescampPlugin\Elementor\Controls\TCG_Helper as ControlsHelper; 
...
class TCG_Dynamic_Slider extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'all' => esc_html__('All', 'themescamp-plugin'),
                ],
                'label_block' => true,
                'default' => 'bullets',
                'condition' => [
        ...
        $this->add_control(
            'float_cursor_text',
            [
                'label' => esc_html__('Float Cursor Text', 'themescamp-elements'),
                'default' => esc_html__('Hold And Drag', 'themescamp-elements'),
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'condition' => [
                    'pagination' => 'true',
                    'paginationType' => ['progressbar', 'all']
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Pagination Width', 'themescamp-elements' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'fraction_pagination_position',
            [
                'label' => esc_html__( 'Pagination Position', 'themescamp-elements' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'left: {{SIZE}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'right: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'right: {{SIZE}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'left: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'pagination_fraction_fraction_offset_orientation_h' => 'end',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination.swiper-pagination-fraction' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'pagination_fraction_fraction_offset_orientation_v' => 'end',
                ],
        ...
        $this->add_control(
            'pagination_fraction_dark_mode_heading',
            [
        ...
        $this->add_control(
            'pagination_fraction_text_color_dark_mode',
            [
                'label' => esc_html__( 'Text Color', 'themescamp-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination-fraction' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-dynamic-slider .swiper-pagination-fraction' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'pagination_fraction_current_opacity',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination-fraction .swiper-pagination-current' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'pagination_fraction_mark_opacity',
            [
                'label' => esc_html__( 'Mark Opacity', 'themescamp-elements' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination-fraction .slide-mark' => 'opacity: {{SIZE}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'pagination_fraction_total_opacity',
            [
                'label' => esc_html__( 'Total Opacity', 'themescamp-elements' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .swiper-pagination-fraction .swiper-pagination-total' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tcg-dynamic-slider .tcg-float-cursor',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcg-dynamic-slider .tcg-float-cursor' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
...
?>
        ...
        <div id="<?php echo esc_attr($max_slider_id) ?>" class="tcg-dynamic-slider<?php if($settings['display_for_active_slide'] == 'true') echo esc_attr(' dynamic-slider-active-content'); if($settings['float_cursor'] === 'true') echo esc_attr(' tcg-float-cursor-container'); ?>" data-tcg-dynamic-slider='<?php echo esc_attr(json_encode($slider_settings)); ?>'>
            ...
            <?php if ($settings['pagination'] === 'true') : ?>
                ...
                <?php if ($settings['paginationType'] === 'all') : ?>
                    <div class="swiper-pagination swiper-pagination-<?= $settings['direction'] ?> swiper-pagination-progressbar custom-swiper-pagination-progressbar"> <span class="swiper-pagination-progressbar-fill"></span> </div>
                    <div class="swiper-pagination swiper-pagination-<?= $settings['direction'] ?> swiper-pagination-fraction"></div>
                <?php endif; ?>
            ...
            <?php if($settings['float_cursor'] === 'true'): ?>
                <div class="tcg-float-cursor"><?= $settings['float_cursor_text'] ?></div>
            <?php endif; ?>
