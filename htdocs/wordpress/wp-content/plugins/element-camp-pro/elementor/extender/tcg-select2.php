...
class TCG_Pro_Select2
{
    ...
    {
        if ( class_exists( 'ThemescampPlugin\Elementor\Controls\Themescamp_Select2' ) ) {
            $controls_manager->register_control('tcg-select2', new \ThemescampPlugin\Elementor\Controls\Themescamp_Select2());
        }
    }
