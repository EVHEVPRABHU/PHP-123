...
if ( ! defined( 'ITEM_THEME_NAME' ) ) { define("ITEM_THEME_NAME",get_option('tcg_theme_name')); }
if ( ! defined( 'item_id' ) ) {define("item_id",get_option('tcg_theme_id')); }
if ( ! defined( 'item_theme_version' ) ) {define("item_theme_version",get_option('tcg_theme_version'));}



if ( ! class_exists( 'Tcg_Register_Page' ) ) {
...
if ( ! function_exists( 'tcg_registration_page' ) ) {
...
if ( ! function_exists( 'tcg_activate_link' ) ) {
...
if ( ! function_exists( 'customer_plugin_handle_token' ) ) {
...
if ( ! function_exists( 'customer_plugin_admin_notices' ) ) {
...
if ( ! function_exists( 'handle_revoke_elements_token' ) ) {
...
if ( ! function_exists( 'tcg_handle_purchase_key' ) ) {
