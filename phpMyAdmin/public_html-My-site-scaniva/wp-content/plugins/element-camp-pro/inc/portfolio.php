...
if ( ! function_exists( 'themescamp_portfolio_post_type' ) ) {
...
if ( ! function_exists( 'themescamp_taxonomies_portfolio' ) ) {
...
if ( ! function_exists( 'themescamp_taxonomies_portfolio_tag' ) ) {
...
if ( ! function_exists( 'themescamp_secondary_portfolio_image' ) ) {
...
if ( ! function_exists( 'themescamp_sec_img_callback' ) ) {
...
if ( ! function_exists( 'themescamp_custom_portfolio_link' ) ) {
...
if ( ! function_exists( 'themescamp_portfolio_custom_link_callback' ) ) {
...
if ( ! function_exists( 'themescamp_save_sec_img' ) ) {
...
if ( ! function_exists( 'themescamp_save_custom_link' ) ) {
...
if ( ! function_exists( 'themescamp_custom_portfolio_permalink' ) ) {
