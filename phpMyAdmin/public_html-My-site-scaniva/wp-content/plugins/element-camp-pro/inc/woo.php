...
if ( ! function_exists( 'themescamp_single_product_woocommerce_body_class' ) ) {
...
if ( ! function_exists( 'themescamp_add_woocommerce_support' ) ) {
 ...
 */
if ( ! function_exists( 'themescamp_add_to_cart_fragment' ) ) {
