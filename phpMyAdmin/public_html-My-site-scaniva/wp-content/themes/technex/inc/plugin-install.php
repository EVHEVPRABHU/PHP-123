 ...
 *
 * @see http://tgmpluginactivation.com/configuration/ for detaitechnex documentation.
 *
...
add_action( 'tgmpa_register', 'technex_theme_register_required_plugins' );
/**
 ...
 */
function technex_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html__( 'ThemesCamp Elements', 'technex' ),
		...
		array(
			'name'               => esc_html__( 'ThemesCamp Core', 'technex' ),
	...
	$config = array(
		...
		'default_path' => '',                      // Default absolute path to bundtechnex plugins.
